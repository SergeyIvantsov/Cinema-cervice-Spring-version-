INSERT INTO cinema_service_spring.films (id, title, genre, description, release_year, director_id) VALUES (1, 'Джентельмены удачи', 'комедия', 'Заведующему детсадом Трошкину фатально не повезло: он оказался как две капли воды похож на бандита по кличке «Доцент», похитившего уникальный шлем Александра Македонского.', 1971, 1);
INSERT INTO cinema_service_spring.films (id, title, genre, description, release_year, director_id) VALUES (2, 'Гладиатор', 'историческая драма', 'В великой Римской империи не было военачальника, равного генералу Максимусу. Непобедимые легионы, которыми командовал этот благородный воин, боготворили его и могли последовать за ним даже в ад.', 2000, 2);
INSERT INTO cinema_service_spring.films (id, title, genre, description, release_year, director_id) VALUES (3, 'иван васильевич меняет профессию', 'комедия', 'Инженер-изобретатель Тимофеев сконструировал машину времени, которая соединила его квартиру с далеким шестнадцатым веком — точнее, с палатами государя Ивана Грозного. Туда-то и попадают тезка царя пенсионер-общественник Иван Васильевич Бунша и квартирный вор Жорж Милославский.', 1973, 3);
INSERT INTO cinema_service_spring.films (id, title, genre, description, release_year, director_id) VALUES (6, 'Нечто', 'ужасы', 'Команде ученых американской исследовательской базы в Антарктике предстоит столкнуться с необъяснимым, чудовищным кошмаром. Отрезанные от всего света полярники вступают в неравную схватку с инопланетной тварью, пробудившейся после тысячелетней спячки во льдах.', 1982, 4);
...
INSERT INTO cinema_service_spring.users (id, username) VALUES (1, 'user');
